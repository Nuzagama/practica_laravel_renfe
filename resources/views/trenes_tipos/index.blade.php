        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">
                    Tipos de Trenes - <i>La Renfe Buena</i>
                </h2>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-1 gap-6 lg:gap-8">
                    ...
                    <div class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                        <p class="mt-6 text-m font-semibold text-gray-900 dark:text-white">
                            <br>
                            Aquí puedes ver los tipos de distancia que recorren nuestros trenes. <br> También puedes crear nuevos tipos, editarlos o eliminarlos.
                        </p>
                        ...
                        <p id="newTicket" class="mt-6 text-m font-semibold text-gray-900 dark:text-white">
                            ...
                            <br><br>
                            ¿Quieres crear un nuevo Tren tipo? &nbsp;
                            <a href="{{ route('trenes_tipos.create') }}">➕</a>
                        </p>
                            ...
                            <table class="table-auto">
                                ...
                                <tbody class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('trenes_tipos.show', $trainType->id) }}">🔎</a>
                                            <a href="{{ route('trenes_tipos.edit', $trainType->id) }}">✏️</a>
                                            <form action="{{ route('trenes_tipos.destroy', $trainType->id) }}" method="POST" style="display: inline;">
                                                @csrf
                                                @method('DELETE')
